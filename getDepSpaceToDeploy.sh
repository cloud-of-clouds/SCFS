...
java -cp bin:lib/DepSpace.jar:lib/PVSS.jar:lib/netty-3.1.1.GA.jar:lib/SMaRt.jar:lib/groovy-1.0-JSR-06.jar:lib/commons-codec-1.5.jar server.Main " > DepSpace/runDepSpace.sh;
